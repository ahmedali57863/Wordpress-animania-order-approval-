...
Contributors: webtechstreet, freemius
...
= 2.25.3 = 
* Reverted the changes from last release which is causing Elementor editor to break. 
...
= 2.21.2 = 
* Enhancement : Widget Title option added to ACF Gallery, Post Block, Post Block Adv, AE-Repeater
* Enhancement : Download option added to ACF URL, File & Image skin
* Enhancement : Added support for acf date field in ACF Field widget
* Enhancement : Download option added to Pods Website & Image skin
* Enhancement : Post Block Adv query section enhanced. Added get posts by current author & logged-in user option in author.
* Enhancement : Post Block Adv added new Infinite Scroll loader icons
* Enhancement : Strip Text option added to ACF Text, Textarea, & WYSIWYG
...
= 2.20.4 =
* Fixed: Issue with ACF Field field data.
...
= 2.20.1 =
* Fixed: Issue in Post Title widget
