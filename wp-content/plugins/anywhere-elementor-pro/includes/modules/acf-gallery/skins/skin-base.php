...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	public function thumbnail_controls(){
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'      => [
					'{{WRAPPER}} .ae-thumb-horizontal-bottom' => 'margin-top: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .ae-thumb-horizontal-top' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function common_controls() {
		...
		$this->add_control(
			'reverse_direction',
			[
				'label'        => __( 'Reverse Direction', 'ae-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description' => __( 'Autoplay in reverse direction', 'ae-pro' ),
				'default'      => '',
	...
	public function get_swiper_data() {
		...
		if ( $this->get_instance_value( 'autoplay' ) === 'yes' ) {
			...
			$swiper_data['autoplay']['reverseDirection']     = ( $this->get_instance_value( 'reverse_direction') === 'yes' );
			if($this->get_instance_value( 'reverse_direction') === 'yes'){
				$swiper_data['initialSlide'] = $this->get_instance_value( 'slides_per_view' )['size'] - 1;
			}
		} else {
