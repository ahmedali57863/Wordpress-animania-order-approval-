...
class Skin_Carousel extends Skin_Base {
	...
	public function render() {
		...
		$swiper_class = '';
		$swiper_class = Plugin::$instance->experiments->is_feature_active( 'e_swiper_latest' ) ? '' : 'swiper-container';
		$this->parent->add_render_attribute( 'collection', 'class', ['ae-swiper-container'] );
		$ae_slider_id = wp_rand( 0, 99999 );
		$this->parent->add_render_attribute( 'collection', 'data-ae-slider-id', $ae_slider_id );
		$this->parent->add_render_attribute( 'outer-wrapper', 'class', 'ae-slider-id-' . $ae_slider_id );
