...
class WooSubscriptionCancelledTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'woocommerce_subscription_status_cancelled';
        $this->priority = 22;
        $this->actionArgNum = 1;
        parent::__construct();
    }
    ...
    public function getTrigger()
    {
        return [
            ...
            'label'       => __('Subscription Cancelled', 'fluentcampaign-pro'),
            'icon'        => 'fc-icon-woo_order_complete',
            'description' => __('This funnel will start when a WooCommerce subscription is cancelled.', 'fluentcampaign-pro')
        ];
    }
    ...
    public function getConditionFields($funnel)
    {
        return [
            'product_ids'  => [
                ...
                'inline_help'        => __('Keep it blank to run to any subscription starts', 'fluentcampaign-pro')
            ],
            'run_multiple' => [
                'type'        => 'yes_no_check',
                'label'       => '',
    ...
    {
        return [
            'title'     => __('Subscription Cancelled', 'fluentcampaign-pro'),
            'sub_title' => __('This funnel will start when a WooCommerce subscription is cancelled.', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status'      => [
